  ...
  return (
    <div className="flex flex-col bg-white mt-10 sm:mt-16 md:mt-24 lg:mt-32 xl:mt-40 mb-10">
      <div className="self-stretch bg-white">
        <div className="flex flex-col items-start self-stretch bg-[#FF4545] py-8 px-6 sm:px-12 md:px-24 lg:px-32 xl:px-60">
          {/* 상단 네비게이션 */}
          <div className="flex flex-wrap gap-5 mb-25">
            ...
            <span className="text-white text-xs font-bold">마이페이지</span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center w-full mb-4 gap-6">
            ...
            <span className="font-playfair text-white text-3xl md:text-4xl font-bold">
              Marketer’s Fridge
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-4">
            ...
            <div className="flex flex-wrap gap-4">
              <span className="text-white text-xs">이용약관</span>
              <span className="text-white text-xs">개인정보처리방침</span>
              <span className="text-white text-xs">서비스 이용 문의</span>
