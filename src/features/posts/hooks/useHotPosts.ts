...
const hotMock = (limit: number): PostResponseDto[] =>
  Array.from({ length: limit }).map((_, idx) => {
    ...
    return {
      ...
      type: "CARD_NEWS",
      content:
        "제니(@jennierubyjane)의 취향은 곧 모두의 취향이 된다는 ’제니 효과‘의 비밀은 단순한 유명세가 아니었어요. 제니는 단순한 모델 역할을 넘어, 직접 디자인에 참여하는 크리에이터로서 한국 전통 나전칠기의 우아한 감성을 담아냈죠. 패키지부터 텀블러에 달린 귀여운 참까지, 그녀의 섬세한 터치는 팬들의 소장 욕구를 완벽하게 자극했어요. \n\n 여기에 스탠리(@stanley_korea)는 팝업 스토어에 팬들을 위한 백스테이지 무드를 구현하고, 한정판 출시로 색다른 경험을 선물했습니다. 이처럼 팬심을 이해하고 소통하는 마케팅은 역대급 반응을 일으키며, 스탠리가 110년 전통을 넘어 라이프스타일의 완성으로 자리 잡게 했어요...",
