    ...
    <div className="bg-white pt-11 md:pt-0">
      ...
      <section className="flex py-5 md:py-10 px-[5%] lg:px-[17%] main-red text-white w-full">
        <div className="w-full flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center w-[1/2] gap-[5%] sm:gap-[10%]">
            ...
            <div className="w-full flex flex-col items-center md:items-start">
              ...
              <button
                ...
                className="w-full mt-2 border border-white rounded-full text-xs px-4 py-1 sm:text-sm"
              >
                프로필 편집
              </button>
            </div>
          ...
          {/* 오른쪽: 계정 관리 & 내 문의 내역 */}
          <div className="mt-10 md:mt-0 flex w-full md:w-[50%] text-sm sm:text-lg gap-5 md:text-2xl font-semibold justify-end">
      ...
      {/* 📦 콘텐츠 영역 (2x2 분할) */}
      <section className="max-w-[1024px] mx-auto px-6 py-18 grid grid-cols-1 md:grid-cols-2 gap-15">
        {/* 1️⃣ 최근 본 콘텐츠 */}
        <div>
          ...
          {/* 모바일 슬라이드 */}
          <div className="md:hidden flex overflow-x-auto gap-4 no-scrollbar snap-x snap-mandatory">
            {recentlyViewedContents.map((item, index) => (
              <div key={index} className="flex-shrink-0 w-[35vw] snap-start">
                <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
                  <Image
                    src="/icons/rectangle-gray.png"
                    alt={item}
                ...
                <div className="pt-2 px-1 text-sm font-semibold flex items-center justify-between">
                  ...
                  <button onClick={() => handleToggleLike(index)}>
                    <Image
                      ...
                      height={20}
                      className={`w-4.5 h-5 ${
                        likedItems.includes(index) ? "" : "opacity-30 grayscale"
                      }`}
                    />
                  </button>
                </div>
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center pt-5">
            <DoughnutChart />
